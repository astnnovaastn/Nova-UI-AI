...
try:
    ...
    print("   [INFO] Storage file: {}".format(agent.memory_system.storage_file))
    ...
    print("   [INFO] Storage file: {}".format(organizer.memory_file_path))
    ...
    print("   [INFO] Memory keys: {}".format(list(memory_for_ai.keys())))
    ...
    print("   [INFO] Conversations stored: {}".format(conversation_count))
