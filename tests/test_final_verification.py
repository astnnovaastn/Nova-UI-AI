...
def test_final():
    ...
    print("   ✓ Duplicate sentence removal is working (e.g., 'Nemzz likes programming. Nemzz likes programming.' -> 'Nemzz likes programming.')")
    print("   ✓ The function also handles some conjunction-based duplicates")
